...
class Settings(BaseSettings):
    ...
    PARALLEL_UPLOAD_MAX_MEMORY_PERCENT: float = 30.0  # Max 30% memory usage
    # When memory threshold is exceeded, automatically destroy the file record/storage
    MEMORY_EXCEEDED_FILE_DESTRUCTION: bool = True

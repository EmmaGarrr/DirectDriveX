...
class Settings(BaseSettings):
    ...
    PARALLEL_UPLOAD_CHUNK_SIZE_MB: int = 16  # 16MB chunks for optimal performance
    PARALLEL_UPLOAD_MAX_CONCURRENT_CHUNKS: int = 20  # Max 20 chunks simultaneously for true parallelism
    ...
    PARALLEL_UPLOAD_HTTP_CONNECTIONS: int = 25  # Max HTTP connections for parallel uploads

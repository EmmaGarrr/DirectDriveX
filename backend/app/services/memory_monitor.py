...
class MemoryMonitor:
    ...
    def __init__(self):
        ...
        self.max_memory_usage_percent = getattr(settings, 'PARALLEL_UPLOAD_MAX_MEMORY_PERCENT', 30.0)
        self.enable_file_destruction = getattr(settings, 'MEMORY_EXCEEDED_FILE_DESTRUCTION', True)
